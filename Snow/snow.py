...
speedOnScreen = False
speedFrequency = 2500                           #How often speed powerup appears
shield = pygame.image.load("shield.gif")
shieldDuration = 500                            #Number of ticks shield powerup lasts
...
while True:
    ...
    if ticks%increaseRate == 0 and snowFrequency > 8:
        snowFrequency -= 1
        snowSpeed += 0.15
    ...
    if ticks > shieldStart+shieldDuration:
        ...
        invincible = True
        window.blit(pygame.transform.scale(shield, (54,60)), (1240,0))
